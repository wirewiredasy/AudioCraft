...
export default function HomePage() {
  const features = [
    ...
    },
    {
      icon: Play,
      title: 'Audio Player',
      description: 'High-quality audio playback with waveform visualization',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                to="/vocal-remover"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-red-500/25"
              >
              ...
              <button className="inline-flex items-center px-8 py-4 border border-white/20 text-white font-semibold rounded-xl hover:bg-white/10 transition-all duration-300">
                View Demo
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <Link
                    to={feature.path}
                    className="netflix-card block p-8 h-full group cursor-pointer"
                  >
