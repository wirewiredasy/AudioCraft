  ...
  return (
    <Dialog.Root open={open} onOpenChange={onClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-0 right-0 h-full w-80 bg-gray-900 border-l border-gray-700 shadow-xl z-50 overflow-y-auto">
          <VisuallyHidden.Root>
            <Dialog.Title>Navigation Menu</Dialog.Title>
            <Dialog.Description>Navigate through different sections of the application</Dialog.Description>
          </VisuallyHidden.Root>
