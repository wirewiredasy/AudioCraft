  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-20">
    <div class="max-w-4xl mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600">Terms and conditions</p>
      </div>

      <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
        <p class="text-gray-600 text-center">Terms of service content coming soon...</p>
      </div>
    </div>
  </div>
</template>
...
<script setup>
useHead({
  title: 'Terms of Service - ODOREMOVER',
  meta: [{ name: 'description', content: 'ODOREMOVER terms of service' }]
})
</script>
