...
<template>
  <div class="max-w-4xl mx-auto px-4 py-20">
    ...
    <div class="card p-8">
      <p class="text-gray-600 text-lg">Cookie policy content coming soon...</p>
    </div>
  </div>
</template>
...
<script setup>
useHead({
  title: 'Cookie Policy - ODOREMOVER'
})
</script>
<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-20">
    <div class="max-w-4xl mx-auto px-6">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600">How we use cookies</p>
      </div>

      <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/20">
        <p class="text-gray-600 text-center">Cookie policy content coming soon...</p>
      </div>
    </div>
  </div>
</template>
...
useHead({
  title: 'Cookie Policy - ODOREMOVER',
  meta: [{ name: 'description', content: 'ODOREMOVER cookie policy' }]
})
</script>
